...
// 			{className && <img loading='lazy' className={className} src={imageMobile} alt={alt} />}
// 			{!className && <img loading='lazy' src={imageMobile} alt={alt} />}
// 		</picture>
// 	);
...
// 					</div>
// 					<div className="logo">
// 						<img loading='lazy' src={Images.LogoBg} alt='logo-bg' className="logo-background" />
...
// 					<img loading='lazy' src={Images.LogoFeature} alt='logofeature' className="logo-ft-img" />
...
// 					</ul>
// 				</div>
// 				<img loading='lazy' src={Images.LogoFtBg} alt='logo' className="logo-ft-bg" />
// 			</div>
// 			<div className="separation">
// 				{renderImage(Images.Separation, Images.SeparationMobile, "separation", "separation-img")}
// 			</div>
