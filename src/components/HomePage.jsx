			...
			<div className='' id='solution'>
				...
				<div className='solution-content'>
					<div className='single-solution'>
						...
						<p>
							An NFT eco-system built by fans that incentivizes football clubs and players to endorse their supporter.
						</p>
					</div>
					<div className='single-solution'>
						<img loading='lazy' alt='solution' src={Images.Solution2} />
						<p>
							Decentralized oracle and incentive that builds a bidirectional interaction between the eco-system and
							real life.
						</p>
					</div>
					<div className='single-solution'>
						<img loading='lazy' alt='solution' src={Images.Solution3} />
						<p>A loyalty farming protocol that promotes the long lasting contribution of users inside a pool.</p>
					</div>
				</div>
			</div>
					...
					<ul className='ft-content'>
						<li className='ft-unique'>
							...
							<p className='ft-unique-content'>
								<span className='ft-ct-active'>Loyalty-oriented NFT framework</span>
							</p>
						</li>
						<li className='ft-unique'>
							...
							<p className='ft-unique-content'>
								{' '}
								Game economics bootstrapped by <span className='ft-ct-active'>loyalty farming protocol</span>
							</p>
						</li>
						<li className='ft-unique'>
						...
						<li className='ft-unique'>
							...
							<p className='ft-unique-content'>
								<span className='ft-ct-active'>Fan Token</span> and DeFi Liquidity token utility
							</p>
						</li>
						<li className='ft-unique'>
